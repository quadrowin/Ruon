...
class LoaderStandartTest extends \PHPUnit_Framework_TestCase
{
	...
	/**
	 * @covers Ruon\Loader\LoaderStandart::getLoadedClasses
	 * @covers Ruon\Loader\LoaderStandart::setLoadedClasses
	 */
     ...
     *
	 * @covers Ruon\Loader\LoaderStandart::load
    ...
    {
        $this->object->setPath('Ruon\\', __DIR__ . '/../');

		// no file
		$this->assertFalse($this->object->load('Ruon\\\\Unexists'));
    }
