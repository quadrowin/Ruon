...
require_once dirname (__FILE__) . '/../../../Core/Annotation/AnnotationManagerAbstract.php';
...
class AnnotationManagerAbstractTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp ()
	{
		$this->object = $this->getMockForAbstractClass(
			'Ruon\\Core\\Annotation\\AnnotationManagerAbstract',
			array(),
			'',
			true,
			true,
		...
		$mockRepository = $this->getMockForAbstractClass(
			'Ruon\\Core\\Data\\DataRepositoryAbstract',
			array(),
			'',
			true,
			true,
	...
	/**
	 * Ruon\Core\Annotation\AnnotationManagerAbstract::getAnnotation
	 */
	...
	/**
	 * @covers Ruon\Core\Annotation\AnnotationManagerAbstract::getRepository
	 * @covers Ruon\Core\Annotation\AnnotationManagerAbstract::setRepository
	 */
	...
	/**
	 * @covers Ruon\Core\Annotation\AnnotationManagerAbstract::getSource
	 * @covers Ruon\Core\Annotation\AnnotationManagerAbstract::setSource
	 */
